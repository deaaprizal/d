          ...
          <div className="content">
            ...
            <div>
              ...
              <code>
                ...
                website components, Basic knowledge of UIUX, Knowledge of
                styling CSS native code, Knowledge of responsive structure &
                Improving design guideline.
              </code>
            </div>
            <div className="text-center mt-20">
              <button
                className="btn btn-md"
                onClick={() => (window.location.href = "/d/frontend")}
              >
                Ikuti Journey Frontend
              </button>
            </div>
          </div>
        </div>
